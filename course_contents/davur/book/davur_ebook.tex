...
\NormalTok{get_attribute_info <-}\StringTok{ }\ControlFlowTok{function}\NormalTok{(attribute, }\DataTypeTok{resource =} \StringTok{"label"}\NormalTok{) \{}
    \ControlFlowTok{if}\NormalTok{ (}\OperatorTok{!}\StringTok{ }\NormalTok{resource }\OperatorTok{%in%}\StringTok{ }\KeywordTok{c}\NormalTok{(}\StringTok{"label"}\NormalTok{, }\StringTok{"description"}\NormalTok{)) \{}
...
{\centering \includegraphics[width=0.7\linewidth]{davur_ebook_files/figure-latex/corr-to-dependent-1} 
...
{\centering \includegraphics[width=0.7\linewidth]{davur_ebook_files/figure-latex/corr-to-dependent-2} 
...
{\centering \includegraphics[width=0.7\linewidth]{davur_ebook_files/figure-latex/corr-to-dependent-3} 
...
{\centering \includegraphics[width=0.7\linewidth]{davur_ebook_files/figure-latex/corr-to-dependent-4} 
...
{\centering \includegraphics[width=0.7\linewidth]{davur_ebook_files/figure-latex/corr-to-dependent-5} 
...
{\centering \includegraphics[width=0.7\linewidth]{davur_ebook_files/figure-latex/corr-to-dependent-6} 
...
{\centering \includegraphics[width=0.7\linewidth]{davur_ebook_files/figure-latex/corr-to-dependent-7} 
...
\includegraphics{davur_ebook_files/figure-latex/unnamed-chunk-80-1.pdf}
...
\KeywordTok{plot}\NormalTok{(dilution}\OperatorTok{$}\NormalTok{abs }\OperatorTok{~}\StringTok{ }\NormalTok{dilution}\OperatorTok{$}\NormalTok{prot_conc,}
     \DataTypeTok{main =} \StringTok{"Absorbance as a function of protein concentration"}\NormalTok{,}
     \DataTypeTok{xlab =} \StringTok{"Protein concentration (mg/ml)"}\NormalTok{,}
     \DataTypeTok{ylab =} \StringTok{"Absorbance at 750 nm (AU)"}\NormalTok{,}
...
\includegraphics{davur_ebook_files/figure-latex/unnamed-chunk-89-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{dilution_duplo}\OperatorTok{$}\NormalTok{mean <-}\StringTok{ }\NormalTok{(dilution_duplo}\OperatorTok{$}\NormalTok{abs1 }\OperatorTok{+}\StringTok{ }\NormalTok{dilution_duplo}\OperatorTok{$}\NormalTok{abs2) }\OperatorTok{/}\StringTok{ }\DecValTok{2}
\NormalTok{dilution_duplo}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{barplot}\NormalTok{(dilution_duplo}\OperatorTok{$}\NormalTok{mean }\OperatorTok{~}\StringTok{ }\NormalTok{dilution_duplo}\OperatorTok{$}\NormalTok{prot_conc,}
     \DataTypeTok{main =} \StringTok{"Absorbance as a function of protein concentration"}\NormalTok{,}
     \DataTypeTok{xlab =} \StringTok{"Protein concentration (mg/ml)"}\NormalTok{,}
     \DataTypeTok{ylab =} \StringTok{"Absorbance 750nm (AU)"}\NormalTok{,}
     \DataTypeTok{ylim =} \KeywordTok{c}\NormalTok{(}\DecValTok{0}\NormalTok{, }\DecValTok{1}\NormalTok{),}
     \DataTypeTok{col =} \StringTok{"darkgreen"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\includegraphics{davur_ebook_files/figure-latex/unnamed-chunk-93-1.pdf}
...
\begin{Highlighting}[]
\CommentTok{# Your code here}
\NormalTok{hplc_data <-}\StringTok{ }\NormalTok{hplc_data[}\KeywordTok{order}\NormalTok{(hplc_data}\OperatorTok{$}\NormalTok{conc), ]}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\CommentTok{# Your code here}
\KeywordTok{plot}\NormalTok{(hplc_data}\OperatorTok{$}\NormalTok{peak_area }\OperatorTok{~}\StringTok{ }\NormalTok{hplc_data}\OperatorTok{$}\NormalTok{conc,}
     \DataTypeTok{main =} \StringTok{"Peak area as a function of thymol concentration"}\NormalTok{,}
     \DataTypeTok{xlab =} \StringTok{"Thymol concentration (μg/ml)"}\NormalTok{,}
     \DataTypeTok{ylab =} \StringTok{"Peak area (AU)"}\NormalTok{,}
     \DataTypeTok{col =} \StringTok{"blue"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{reg_mod =}\StringTok{ }\KeywordTok{lm}\NormalTok{(hplc_data}\OperatorTok{$}\NormalTok{peak_area }\OperatorTok{~}\StringTok{ }\NormalTok{hplc_data}\OperatorTok{$}\NormalTok{conc)}
\KeywordTok{abline}\NormalTok{(reg_mod, }\DataTypeTok{col =} \StringTok{"red"}\NormalTok{, }\DataTypeTok{lwd =} \DecValTok{2}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\includegraphics{davur_ebook_files/figure-latex/unnamed-chunk-97-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{##remove temp celcius agan}
\NormalTok{airquality}\OperatorTok{$}\NormalTok{Temp.C <-}\StringTok{ }\OtherTok{NULL}
...
The Ozone\textasciitilde{}Temp pair has the strongest correlation. A scatterplot of this pair:

\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{plot}\NormalTok{(airquality}\OperatorTok{$}\NormalTok{Ozone }\OperatorTok{~}\StringTok{ }\NormalTok{airquality}\OperatorTok{$}\NormalTok{Temp,}
     \DataTypeTok{xlab =} \StringTok{"Temperature (F)"}\NormalTok{,}
     \DataTypeTok{ylab =} \StringTok{"Ozone (ppb)"}\NormalTok{,}
     \DataTypeTok{col =} \StringTok{"blue"}\NormalTok{)}
\NormalTok{ozone_wind_lm <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(airquality}\OperatorTok{$}\NormalTok{Ozone }\OperatorTok{~}\StringTok{ }\NormalTok{airquality}\OperatorTok{$}\NormalTok{Temp)}
\NormalTok{r_squared <-}\StringTok{ }\KeywordTok{round}\NormalTok{(}\KeywordTok{summary}\NormalTok{(ozone_wind_lm)}\OperatorTok{$}\NormalTok{r.squared, }\DecValTok{2}\NormalTok{)}
\KeywordTok{abline}\NormalTok{(ozone_wind_lm, }\DataTypeTok{col =} \StringTok{"red"}\NormalTok{, }\DataTypeTok{lwd =} \DecValTok{2}\NormalTok{)}
\KeywordTok{text}\NormalTok{(}\DataTypeTok{x =} \DecValTok{60}\NormalTok{, }\DataTypeTok{y =} \DecValTok{125}\NormalTok{, }\DataTypeTok{labels =} \KeywordTok{paste0}\NormalTok{(}\StringTok{"R^2 = "}\NormalTok{, r_squared))}
\end{Highlighting}
\end{Shaded}

\begin{figure}
\centering
\includegraphics{davur_ebook_files/figure-latex/airquality-strongest-corr-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{my_file <-}\StringTok{ "file02.txt"}
\NormalTok{my_path <-}\StringTok{ }\KeywordTok{paste0}\NormalTok{(my_dir, }\StringTok{"/"}\NormalTok{, my_file)}
\NormalTok{my_data <-}\StringTok{ }\KeywordTok{read.table}\NormalTok{(}
\NormalTok{    my_path,}
    \DataTypeTok{comment.char =} \StringTok{"$"}\NormalTok{,}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{my_file <-}\StringTok{ "file12.txt"}
\NormalTok{my_path <-}\StringTok{ }\KeywordTok{paste0}\NormalTok{(my_dir, }\StringTok{"/"}\NormalTok{, my_file)}
\NormalTok{my_data <-}\StringTok{ }\KeywordTok{read.table}\NormalTok{(}
\NormalTok{    my_path,}
    \DataTypeTok{header =}\NormalTok{ T,}
    \DataTypeTok{sep =} \StringTok{","}\NormalTok{,}
    \DataTypeTok{dec =} \StringTok{"."}\NormalTok{,}
    \DataTypeTok{na.strings =} \StringTok{"-1"}\NormalTok{,}
    \DataTypeTok{as.is =} \KeywordTok{c}\NormalTok{(}\DecValTok{1}\NormalTok{, }\DecValTok{3}\NormalTok{))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{my_file <-}\StringTok{ "file13.txt"}
\NormalTok{my_path <-}\StringTok{ }\KeywordTok{paste0}\NormalTok{(my_dir, }\StringTok{"/"}\NormalTok{, my_file)}
\NormalTok{my_data <-}\StringTok{ }\KeywordTok{read.table}\NormalTok{(}
\NormalTok{    my_path,}
    \DataTypeTok{comment.char =} \StringTok{"$"}\NormalTok{,}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{my_file <-}\StringTok{ "file14.txt"}
\NormalTok{my_path <-}\StringTok{ }\KeywordTok{paste0}\NormalTok{(my_dir, }\StringTok{"/"}\NormalTok{, my_file)}
\NormalTok{my_data <-}\StringTok{ }\KeywordTok{read.table}\NormalTok{(}
\NormalTok{    my_path,}
    \DataTypeTok{comment.char =} \StringTok{"$"}\NormalTok{,}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{##alternatively, convert it after loading:}
\CommentTok{#bird_obs$Count <- as.numeric(as.character(bird_obs$Number))}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{bird_obs[bird_obs}\OperatorTok{$}\NormalTok{Count }\OperatorTok{==}\StringTok{ }\KeywordTok{max}\NormalTok{(bird_obs}\OperatorTok{$}\NormalTok{Count, }\DataTypeTok{na.rm =}\NormalTok{ T), ]}
\CommentTok{##OR}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{shapiro.test}\NormalTok{(bird_obs}\OperatorTok{$}\NormalTok{Count)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{common_names <-}\StringTok{ }\KeywordTok{unique}\NormalTok{(bird_obs}\OperatorTok{$}\NormalTok{Common.name)}
\NormalTok{scientific_names <-}\StringTok{ }\KeywordTok{unique}\NormalTok{(}\KeywordTok{paste0}\NormalTok{(bird_obs}\OperatorTok{$}\NormalTok{Genus, }\StringTok{" "}\NormalTok{, bird_obs}\OperatorTok{$}\NormalTok{Species))}
\KeywordTok{paste0}\NormalTok{(}\StringTok{"number of common names: "}\NormalTok{, }\KeywordTok{length}\NormalTok{(common_names), }\StringTok{"; number of scientific names: "}\NormalTok{,  }\KeywordTok{length}\NormalTok{(scientific_names))}
\end{Highlighting}
\end{Shaded}
...
My guess is that one more species has two common names for two \emph{subspecies} where, of course, there will be only one scientific species name. Which? Dunno. Can you find out?

OK, I couldn't help myself. I do NOT expect you to be able to do serious mangling like this at the end of this course!

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{scientific_all <-}\StringTok{ }\KeywordTok{paste0}\NormalTok{(bird_obs}\OperatorTok{$}\NormalTok{Genus, }\StringTok{" "}\NormalTok{, bird_obs}\OperatorTok{$}\NormalTok{Species)}
\CommentTok{##combine scientific and common andf make unique}
\NormalTok{combined <-}\StringTok{ }\KeywordTok{unique}\NormalTok{(}\KeywordTok{paste0}\NormalTok{(scientific_all, }\StringTok{":"}\NormalTok{, bird_obs}\OperatorTok{$}\NormalTok{Common.name))}
\CommentTok{#split it again, and convert to dataframe (strsplit gives a list)}
\NormalTok{combined_split <-}\StringTok{ }\KeywordTok{strsplit}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ combined, }\DataTypeTok{split =} \StringTok{":"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\begin{verbatim}
## Warning in strsplit(x = combined, split = ":"): input string 189 is invalid
## in this locale
\end{verbatim}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{combined_split <-}\StringTok{ }\KeywordTok{as.data.frame}\NormalTok{(}\KeywordTok{do.call}\NormalTok{(rbind, combined_split))}
\CommentTok{#count frequencies of Scinetific names}
\NormalTok{combined_split_table <-}\StringTok{ }\KeywordTok{as.data.frame}\NormalTok{(}\KeywordTok{table}\NormalTok{(combined_split[,}\DecValTok{1}\NormalTok{]))}
\CommentTok{#where is the count above 1?}
\NormalTok{combined_split_table[combined_split_table}\OperatorTok{$}\NormalTok{Freq }\OperatorTok{>}\StringTok{ }\DecValTok{1}\NormalTok{, ]}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{species_sel <-}\StringTok{ }\NormalTok{combined_split_table[combined_split_table}\OperatorTok{$}\NormalTok{Freq }\OperatorTok{>}\StringTok{ }\DecValTok{1}\NormalTok{, ]}\OperatorTok{$}\NormalTok{Var1}
\NormalTok{species_sel}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{combined_split[combined_split}\OperatorTok{$}\NormalTok{V1 }\OperatorTok{%in%}\StringTok{ }\NormalTok{species_sel, ]}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{davur_ebook_files/figure-latex/unnamed-chunk-142-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{weight_gain <-}\StringTok{ }\ControlFlowTok{function}\NormalTok{(x) \{}
    \CommentTok{#x is a dataframe}
\NormalTok{    leaded <-}\StringTok{ }\KeywordTok{c}\NormalTok{(x}\OperatorTok{$}\NormalTok{weight)}
\NormalTok{    lagged <-}\StringTok{ }\KeywordTok{c}\NormalTok{(}\OtherTok{NA}\NormalTok{, x}\OperatorTok{$}\NormalTok{weight[}\DecValTok{1}\OperatorTok{:}\NormalTok{(}\KeywordTok{length}\NormalTok{(x}\OperatorTok{$}\NormalTok{weight)}\OperatorTok{-}\DecValTok{1}\NormalTok{)])}
\NormalTok{    x}\OperatorTok{$}\NormalTok{gain <-}\StringTok{ }\NormalTok{leaded }\OperatorTok{-}\StringTok{ }\NormalTok{lagged}
\NormalTok{    x}
\NormalTok{\}}

\NormalTok{split_cw <-}\StringTok{ }\KeywordTok{split}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ ChickWeight, }\DataTypeTok{f =}\NormalTok{ ChickWeight}\OperatorTok{$}\NormalTok{Chick)}
\NormalTok{new_cw <-}\StringTok{ }\KeywordTok{do.call}\NormalTok{(rbind, }\KeywordTok{lapply}\NormalTok{(}\DataTypeTok{X =}\NormalTok{ split_cw, }\DataTypeTok{FUN =}\NormalTok{ weight_gain))}

\KeywordTok{head}\NormalTok{(new_cw)}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{davur_ebook_files/figure-latex/unnamed-chunk-152-1.pdf}
...
\includegraphics{davur_ebook_files/figure-latex/unnamed-chunk-153-1.pdf}
